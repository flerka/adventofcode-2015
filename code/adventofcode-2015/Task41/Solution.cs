...
namespace adventofcode_2015.Task41
{
    ...
    {
        /// <summary>
        /// Solution for the first https://adventofcode.com/2015/day/21/ task
        /// </summary>
        public static int Function(Shop shop, UserStats enemyStats, int hitPoints)
        {
            ...
            double leastGold = double.PositiveInfinity;
            foreach (var weapon in weapons)
            {
                foreach (var armor in armors)
                {
                    foreach (var ringsComb in ringsCombinations)
                    {
                        ...
                        if (isWin)
                        {
                            leastGold = Math.Min(leastGold, resultStats.Item2);
                        }
                    }
                }
            }

            return (int)leastGold;
        }
